...
with open(r"C:\Users\ADMIN\OneDrive\Desktop\UTH\Flet\Flet\dictionary.json", "r", encoding="utf-8") as f:
    dictionary = json.load(f)
with open(r"C:\Users\ADMIN\OneDrive\Desktop\UTH\Flet\Flet\dictionary_viet_anh.json", "r", encoding="utf-8") as f:
